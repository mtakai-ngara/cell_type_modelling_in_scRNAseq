...
def plot_var_and_modified_genes_intersection(homo_scores_infile, output_dir=None, x_axis='genes_count', 
                                             y_axis='len_mod_and_var_genes',
                                             in_kind='point', in_col_wrap=3, hue='cells_count',hue_palette=None, col_order='fc',
                                             ...
                                             replicates_grps=['method', 'cells_count', 'genes_count', 'fc',
                                                              ...
                                                              'randomize_cells_labels'],show_reps_counts=None,facet_size=4):
...
def plot_genes_with_same_parameter(genes_params_df,fig_out_fname,target_genes,fc=2,mean_interval=1.0,
    ...
    for m  in range(len(target_genes)):
        ...
        param_res_dict=genes_with_same_parameters(genes_params_df=genes_params_df, target_gene=target_gene,
                                                  fc=fc, mean_interval=mean_interval, drop_out_interval=drop_out_interval,
                                                  cv2=cv2)
